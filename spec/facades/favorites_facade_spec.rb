...
RSpec.describe 'FavoritesFacade' do
  it 'returns the current users favorite city/cities correctly' do
    ...
    expect(facade.categories).to be_an(String)
